...
<div id='content' id="connexion"><center>
        ...
        {
            echo "<p id='inscription-ok'>Tobago vous salue, ".$_SESSION['logged_on_user']."!\n</p>";
            echo "<p>Allez faire un tour dans notre <a href=../boutique.php>boutique</a>\n</p>";
            echo "<p>Ou amusez vous avec nos pirates à <a href=../../index.php>l'accueil</a>\n</p>";
            $_SESSION['flag_log'] = "";
        }
